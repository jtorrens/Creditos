(function (root) {
  function createAppCartelaEditor(options = {}) {
    ...
    function renderCartelaFields(cartela) {
      ...
      wrap.appendChild(options.localNumberRow('Desplazamiento vertical', Number(effectiveCartela.vertical_offset) || 0, null, null, (value) => options.updateSelectedCartela({ vertical_offset: value }), 1, { override: options.hasCartelaOverride(cartela, 'vertical_offset'), reset: () => options.resetSelectedCartelaOverride('vertical_offset') }));
      ...
      wrap.appendChild(options.localNumberRow('Interlineado', Number(effectiveCartela.line_spacing) || 1.12, 0.1, null, (value) => options.updateSelectedCartela({ line_spacing: value }), 0.01, { override: options.hasCartelaOverride(cartela, 'line_spacing'), reset: () => options.resetSelectedCartelaOverride('line_spacing') }));
      wrap.appendChild(options.localNumberRow('Separación entre columnas', Number(effectiveCartela.column_gap) || 0, 0, null, (value) => options.updateSelectedCartela({ column_gap: value }), 1, { override: options.hasCartelaOverride(cartela, 'column_gap'), reset: () => options.resetSelectedCartelaOverride('column_gap') }));
      wrap.appendChild(options.localNumberRow('Separación cargo/nombre', Number(effectiveCartela.role_name_gap) || 0, 0, null, (value) => options.updateSelectedCartela({ role_name_gap: value }), 1, { override: options.hasCartelaOverride(cartela, 'role_name_gap'), reset: () => options.resetSelectedCartelaOverride('role_name_gap') }));
      wrap.appendChild(options.localNumberRow('Separación de grupos del origen', Number(effectiveCartela.source_group_gap) || 0, 0, null, (value) => options.updateSelectedCartela({ source_group_gap: value }), 1, { override: options.hasCartelaOverride(cartela, 'source_group_gap'), reset: () => options.resetSelectedCartelaOverride('source_group_gap') }));
      wrap.appendChild(options.localNumberRow('Separación entre bloques', Number(effectiveCartela.block_gap) || 0, 0, null, (value) => options.updateSelectedCartela({ block_gap: value }), 1, { override: options.hasCartelaOverride(cartela, 'block_gap'), reset: () => options.resetSelectedCartelaOverride('block_gap') }));
      wrap.appendChild(options.localNumberRow('Separación título/primera fila', Number(effectiveCartela.block_title_gap) || 0, 0, null, (value) => options.updateSelectedCartela({ block_title_gap: value }), 1, { override: options.hasCartelaOverride(cartela, 'block_title_gap'), reset: () => options.resetSelectedCartelaOverride('block_title_gap') }));
      wrap.appendChild(options.localNumberRow('Margen superior', Number(effectiveCartela.page_top_margin) || 0, 0, null, (value) => options.updateSelectedCartela({ page_top_margin: value }), 1, { override: options.hasCartelaOverride(cartela, 'page_top_margin'), reset: () => options.resetSelectedCartelaOverride('page_top_margin') }));
      wrap.appendChild(options.localNumberRow('Margen inferior', Number(effectiveCartela.page_bottom_margin) || 0, 0, null, (value) => options.updateSelectedCartela({ page_bottom_margin: value }), 1, { override: options.hasCartelaOverride(cartela, 'page_bottom_margin'), reset: () => options.resetSelectedCartelaOverride('page_bottom_margin') }));
      wrap.appendChild(options.localNumberRow('Margen izquierdo', Number(effectiveCartela.page_left_margin) || 0, 0, null, (value) => options.updateSelectedCartela({ page_left_margin: value }), 1, { override: options.hasCartelaOverride(cartela, 'page_left_margin'), reset: () => options.resetSelectedCartelaOverride('page_left_margin') }));
      wrap.appendChild(options.localNumberRow('Margen derecho', Number(effectiveCartela.page_right_margin) || 0, 0, null, (value) => options.updateSelectedCartela({ page_right_margin: value }), 1, { override: options.hasCartelaOverride(cartela, 'page_right_margin'), reset: () => options.resetSelectedCartelaOverride('page_right_margin') }));
