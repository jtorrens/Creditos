(function (root) {
  function createCoreDomainComposition(options = {}) {
    ...
    const settingsDomain = root.CreditosDomainSettings.createSettingsDomain({
      ...
      normalizeFontWeight: typographyDomain.normalizeFontWeight,
    ...
    return {
      ...
      fontWeightFromTypography: typographyDomain.fontWeightFromTypography,
      fontWeightOptions: typographyDomain.fontWeightOptions,
      ...
      normalizeFontWeight: typographyDomain.normalizeFontWeight,
      resolveOverride: overridesDomain.resolveOverride,
      resolveFontStyleForWeight: typographyDomain.resolveFontStyleForWeight,
