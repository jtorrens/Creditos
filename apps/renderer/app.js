(function () {
  ...
  const {
    ...
    structureJsonForOutput, transferStructurePresentation,
  ...
  const appCommands = globalThis.CreditosAppCommands.createAppCommands({
    ...
    adjustPdfPageLineAdjustment,
    buildCurrentRenderJson,
    clearCartelaStyleOverrides, createMaterialsFromSource,
    currentProductionEpisodes,
    dbPost,
    defaultImportModelIdInDomain,
    deleteManualCartela,
    ...
    state,
    stripProductionLayoutFromSettings, transferStructurePresentation,
    typographyFields: TYPOGRAPHY_FIELDS,
